...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <?php
        $sql = mysqli_query($dbc, "SELECT * FROM products WHERE category = 'sweatshirts';");
        ...
        <div class="panel panel-default">
          <div class="thumbnail bg-faded">
            ...
            <div class="caption text-center">
              ...
              <p><a href="viewSweatshirt.php?id=<?php echo $productid; ?>" class="btn btn-primary" role="button">View</a></p>
            </div>
          </div>
        </div>
      </div>
